...
function renderHubHTML(recentPapers, paperCount) {
  ...
  const cards = [
    ...
    { icon: "\u{1F50F}", title: "iPatent.me", desc: "Quantum technology patent disclosure framework for prior art documentation.", href: "https://ipatent.me" }
  ];
...
function renderPaperHTML(paper) {
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>' + esc(paper.title) + ' \u2014 QNFO Papers</title><meta name="description" content="' + escAttr(abstract) + '"><meta property="og:title" content="' + escAttr(paper.title) + '"><link rel="canonical" href="https://papers.qnfo.org/papers/' + escAttr(paper.slug) + '"><style>' + COMMON_CSS + '.rendered-md table{border-collapse:collapse;width:100%;margin:1rem 0;font-size:.9em}.rendered-md th{background:#f2f2f2;font-weight:700;border-top:1.5px solid #000;border-bottom:1px solid #000;padding:.45rem .6rem;text-align:left}.rendered-md td{border-bottom:1px solid #ddd;padding:.4rem .6rem;vertical-align:top}.rendered-md tr:last-child td{border-bottom:1.5px solid #000}.rendered-md .math-display{text-align:center;margin:1rem 0;overflow-x:auto}.rendered-md .math-display mjx-container{font-size:1.05em}</style><script>window.MathJax={tex:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:true},svg:{scale:1.1,fontCache:"global"},options:{skipHtmlTags:["script","noscript","style","textarea","pre","code"],enableMenu:false}};</script><script async src="https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-svg-full.js" id="MathJax-script"></script></head><body><nav class="top-nav"><a class="brand" href="https://qnfo.org">\u{1F52C} QNFO</a><a href="/papers">Papers</a><a href="https://qwav.org" class="qwav-badge">QWAV</a></nav><div class="paper-body"><a class="back-link" href="/papers">\u2190 All papers</a><article><h1>' + esc(paper.title) + '</h1><div class="paper-meta">' + (paper.doi ? '<strong>DOI:</strong> <a href="https://doi.org/' + escAttr(paper.doi) + '">' + esc(paper.doi) + "</a><br>" : "") + "<strong>Published:</strong> " + dateStr + '</div><div class="rendered-md">' + renderMarkdown(md) + "</div></article></div></body></html>";
}
...
async function handleLegal(path, env) {
  try {
    ...
    return new Response(
      '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>QNFO ULA v2.0</title><meta name="viewport" content="width=device-width,initial-scale=1.0"><link rel="canonical" href="https://legal.qnfo.org"></head><body style="font-family:system-ui,sans-serif;max-width:860px;margin:0 auto;padding:1.5rem"><nav style="margin-bottom:1.5rem"><a href="https://qnfo.org" style="color:#1a56db;text-decoration:none;font-weight:600">\u2190 QNFO Hub</a></nav><pre style="white-space:pre-wrap;font-family:Consolas,monospace;font-size:.88rem;line-height:1.6">' + (await body).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;") + "</pre></body></html>",
...
//# sourceMappingURL=gateway-worker.js.map
